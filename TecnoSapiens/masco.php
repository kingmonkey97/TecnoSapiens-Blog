...
<body>
    ...
    <h1 id="saludo">Esto es lo mas comentado, <?php echo htmlspecialchars($username); ?></h1>
    ...
    <div class="posts-container">
        <?php 
            // Consulta para obtener las publicaciones con el número de comentarios
            $query = "
                SELECT p.*, COUNT(c.id) AS comment_count 
                FROM post p
                LEFT JOIN comment c ON p.id = c.post_id
                GROUP BY p.id
                ORDER BY comment_count DESC"; // Ordenar por la cantidad de comentarios en orden descendente
